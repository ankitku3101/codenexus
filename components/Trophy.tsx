...
const Trophy = () => {
  return (
    <div>
      <div className="group relative h-[195px] transition-all duration-500 bg-none overflow-hidden hover:h-[351px]">
        <div className="relative bg-gradient-to-tr from-[#fffbf0] to-[#ffdd87] w-[390px] h-[195px] rounded-3xl transition-all duration-500 z-[2] group-hover:shadow-[0_10px_15px_#b1985e]">
          <svg className="absolute right-0 top-1 z-[2]" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width={208} height={208}>
          ...
          <p className="relative text-[#ffc64b] font-['Segoe_UI',Tahoma,Geneva,Verdana,sans-serif] font-bold text-[104px] left-6 p-0 m-0 -top-1">
            1<span className="relative text-[52px] text-[#424c50]">st</span>
          </p>
          <div className="absolute w-[260px] h-[13px] top-[130px] bg-gradient-to-r from-transparent via-[#f7b733] to-transparent z-[1]" />
          <p className="relative font-semibold text-[#6b7578] left-10 text-xl -top-0.5">Hover to reveal</p>
        </div>
        
        <div className="relative hidden w-[390px] h-[156px] bg-gradient-to-bl from-[#fffbf0] to-[#ffdd87] -top-5 z-[1] transition-all duration-1000 rounded-b-3xl overflow-hidden items-center justify-start group-hover:flex">
          <svg className="absolute top-4 right-1 animate-[slide-in-top_1s_cubic-bezier(0.65,0.05,0.36,1)_both]" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width={104} height={104}>
          ...
          <div className="relative h-[98px] top-[13px] mx-5">
            <p className="relative block ml-20 text-[#424c50] tracking-[6px] font-arial mt-6 font-extrabold text-lg">SCORE</p>
            <p className="relative block text-3xl font-extrabold ml-20 text-[#ea9518] -top-1">1105</p>
          </div>
        </div>
      </div>
    </div>
